...
NFA2 "REPEAT", "REPEAT", IMMEDIATE
   ...
   .word __3ER          ; >R
   .word __3ER          ; >R
   .word _AGAIN         ; COMPILE AGAIN
   .word _R_3E          ; R>
   .word _R_3E          ; R>
   .word _2_2D          ; 2-
   .word _THEN          ; COMPILE THEN
   .word _EXIT          ; EXIT
